...
#define DEFAULT_PUMP_ON 200
#define DEFAULT_PUMP_OFF 270
...
#define DEFAULT_MAX_PUMP_ON_WARNING 4200 // 7 mins
#define DEFAULT_MAX_PUMP_ON_ERROR 5400 // 9 Min
#define DEFAULT_NO_FLOW_AUTO 20

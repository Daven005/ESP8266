...
// returns true to indicate success
static bool ICACHE_FLASH_ATTR ds3231_getFlag(uint8 addr, uint8 mask, uint8 *flag) {
	uint8 data[1];
	// get register
	data[0] = addr;
...
// returns true to indicate success
static bool ICACHE_FLASH_ATTR ds3231_setFlag(uint8 addr, uint8 bits, uint8 mode) {
	uint8 data[2];
	data[0] = addr;
	// get status register
...
// returns true to indicate success
bool ICACHE_FLASH_ATTR ds3231_clearOscillatorStopFlag(void) {
...
// returns true to indicate success
bool ICACHE_FLASH_ATTR ds3231_enableSquarewave(void) {
...
// returns true to indicate success
bool ICACHE_FLASH_ATTR ds3231_disableSquarewave(void) {
